# Composed selection/button/nested-failure UI selftest runner (ticket
# 20260912-052823). Patterned from run_share_selftest.ps1 and
# run_button_dispatch_selftest.ps1 combined: five headers now need
# standalone pre-translation (every .h.lm1 anywhere in the combined
# predef chain), staged into one headers dir before the main translation.
...
$LogDir = ""
$FixtureDir = ""
$TestSource = Join-Path $RepoRoot "mixa_manager\tests\mixa_share_button_selftest.lm1"
$TransOut = ""
$ExeOut = ""
$TransStdout = ""
$TransStderr = ""
...
$BaseDir = Join-Path $RepoRoot "build\mixa\claude\share_button"
...
try {
    ...
    Invoke-HeaderTranslation -Name "share_win32" -SourceRel "mixa_manager\mixa_share_win32.h.lm1" -OutName "mixa_share_win32.lm1.h"
    Invoke-HeaderTranslation -Name "share" -SourceRel "mixa_manager\mixa_share.h.lm1" -OutName "mixa_share.lm1.h"
    Invoke-HeaderTranslation -Name "share_button" -SourceRel "mixa_manager\mixa_share_button.h.lm1" -OutName "mixa_share_button.lm1.h"
    Invoke-HeaderTranslation -Name "app_window" -SourceRel "mixa_manager\mixa_app_window.h.lm1" -OutName "mixa_app_window.lm1.h"
    Invoke-HeaderTranslation -Name "button_dispatch" -SourceRel "mixa_manager\mixa_button_dispatch.h.lm1" -OutName "mixa_button_dispatch.lm1.h"

    $TransOut = Join-Path $RunDir "mixa_share_button_selftest.c"
    $ExeOut = Join-Path $RunDir "mixa_share_button_selftest.exe"
    ...
    $HashFiles = @{
        "share_win32_header" = "mixa_manager\mixa_share_win32.h.lm1"
        "share_header" = "mixa_manager\mixa_share.h.lm1"
        "share_impl" = "mixa_manager\mixa_share.lm1"
        "selection_impl" = "mixa_manager\mixa_selection.lm1"
        "share_action_impl" = "mixa_manager\mixa_share_action.lm1"
        "share_button_header" = "mixa_manager\mixa_share_button.h.lm1"
        "share_button_impl" = "mixa_manager\mixa_share_button.lm1"
        "app_window_header" = "mixa_manager\mixa_app_window.h.lm1"
        "app_window_impl" = "mixa_manager\mixa_app_window.lm1"
        "button_dispatch_header" = "mixa_manager\mixa_button_dispatch.h.lm1"
        "button_dispatch_impl" = "mixa_manager\mixa_button_dispatch.lm1"
    }
