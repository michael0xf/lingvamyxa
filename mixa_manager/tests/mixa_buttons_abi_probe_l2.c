 ...
 * field offset of MixaButton/MixaButtonLine/MixaButtonPanel as seen
 * through the L2 header's own l1trans-generated C header (mixa_
 * buttons_l2.h.lm1 -> mixa_buttons_l2.lm1.h). Compiled and run
 * alongside mixa_buttons_abi_probe_real.c; the runner diffs their
 * output byte-for-byte before ever building or running the actual
 * parity harness.
 */
#include <stdio.h>
#include <stddef.h>
#include "mixa_manager/mixa_buttons_l2.lm1.h"
