 ...
 * field offset of MixaAppWindow/MixaAppWindowStack as seen through the
 * L2 header's own l1trans-generated C header (mixa_app_window_l2.h.
 * lm1 -> mixa_app_window_l2.lm1.h). Compiled and run alongside mixa_
 * app_window_abi_probe_real.c; the runner diffs their output byte-for-
 * byte before ever building or running the actual parity harness.
 */
#include <stdio.h>
#include <stddef.h>
#include "mixa_manager/mixa_app_window_l2.lm1.h"
