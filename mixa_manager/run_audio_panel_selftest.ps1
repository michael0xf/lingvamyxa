# Composed MP3 nested panel selftest runner (ticket 20260912-063130,
# stage 2 of the MP3 work). Deterministic fake device, no platform audio
# libs, no directory/file-manager dependency. Patterned from
# run_app_panel_selftest.ps1's own multi-header-translation helper.
...
$RunDir = ""
$LogDir = ""
$TestSource = Join-Path $RepoRoot "mixa_manager\tests\mixa_audio_panel_selftest.lm1"
$TransOut = ""
$ExeOut = ""
$TransStdout = ""
$TransStderr = ""
...
$BaseDir = Join-Path $RepoRoot "build\mixa\claude\audio_panel"
...
try {
    ...
    $TransOut = Join-Path $RunDir "mixa_audio_panel_selftest.c"
    $ExeOut = Join-Path $RunDir "mixa_audio_panel_selftest.exe"
