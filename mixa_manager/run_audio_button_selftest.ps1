# MP3 control adapter selftest runner (ticket 20260912-055917's staged MP3
# work, item 1). Deterministic fake device, no platform audio libs.
# Patterned from run_audio_selftest.ps1 with an added header-translation
# step for the new mixa_audio_button.h.lm1.
...
$RunDir = ""
$LogDir = ""
$TestSource = Join-Path $RepoRoot "mixa_manager\tests\mixa_audio_button_selftest.lm1"
$TransOut = ""
$ExeOut = ""
$TransStdout = ""
$TransStderr = ""
...
$BaseDir = Join-Path $RepoRoot "build\mixa\claude\audio_button"
...
try {
    ...
    $TransOut = Join-Path $RunDir "mixa_audio_button_selftest.c"
    $ExeOut = Join-Path $RunDir "mixa_audio_button_selftest.exe"
