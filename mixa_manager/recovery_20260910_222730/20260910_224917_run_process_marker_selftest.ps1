...
try {
    ...
    try {
        ...
        $HeaderPath = Join-Path $RepoRoot "mixa_manager\mixa_process_marker.h.lm1"
        ...
        $ImplPath = Join-Path $RepoRoot "mixa_manager\mixa_process_marker.lm1"
