...
try {
    ...
    $LinkArgs = @("-std=c99","-Wall","-Wextra","-Wpedantic","-I",".","-I",$HeaderIncludeRoot,$TestObj,$controllerObj,$eventFifoObj,$backendTableObj,$backendHeadlessObj,$backendCtorsObj,$pumpObj,$consoleWindowObj,$fileWin32Obj,$appPathObj,$helpObj,$cmdlineObj,$cmdlineDispatchObj,$processMarkerObj,$processWin32Obj,"-o",$ExeOut)
