...
$Stages = @(
    ...
    @{
        Name = "g_validate"
        Units = @("l2src\parser_text_port.lm2", "l2src\parser_scan_port.lm2", "l2src\parser_alloc_port.lm2", "l2src\parser_dump_port.lm2", "l2src\parser_stack_stream_port.lm2", "l2src\parser_field_parse_port.lm2", "l2src\parser_validate_port.lm2")
        Headers = @("l2src\parser_text_port_l2.h.lm1", "l2src\parser_scan_port_l2.h.lm1", "l2src\parser_alloc_port_l2.h.lm1", "l2src\parser_dump_port_l2.h.lm1", "l2src\parser_stack_stream_port_l2.h.lm1", "l2src\parser_field_parse_port_l2.h.lm1", "l2src\parser_validate_port_l2.h.lm1")
        Funcs = @(
            "lm_p0_text_equals", "lm_p0_identifier_payload",
            "lm_p0_is_horizontal_space", "lm_p0_is_line_break", "lm_p0_line_break_width_at",
            "lm_p0_is_field_space", "lm_p0_is_field_separator", "lm_p0_is_short_form_separator",
            ...
            "lm_p0_append_atom_slice", "lm_p0_append_positional_skip", "lm_p0_append_compact_atom_pieces",
            "lm_p0_parse_append_node_and_update",
            "lm_p0_colon_frame_empty", "lm_p0_colon_trailer_empty",
            "lm_p0_validate_nonempty_colon_frames_in_trailer", "lm_p0_validate_nonempty_colon_frames_in_node",
            "lm_p0_validate_nonempty_colon_frames_in_structure", "lm_p0_path_has_extension"
        )
        # Prior stage's 106 plus Stage g (colon-frame validate +
        # path_has_extension): 6 functions. Does not include Stage
        # f's unit -- g has no dependency on it.
    }
)
