...
# gen0 is gcc of the committed lm1/build/l1trans.lm1.c (tests\l1\run_seed.ps1), the
# previous binary that always exists (Mikhail 2026-09-15), no longer the lm2 seed.
# Every suite must pass on gen0 and on gen2; no step is exempt.
