...
- Следствие: «стабильный L1» сейчас двоится. Пин 65D5 старый; source L1 на
  ...
  и работают (все мои гейты и порты Claude собирались им 13.09). **Сделано
  2026-09-14** (см. пин выше): 65D5 оказался неверно компилирующим внутренний
  вызов модуля в lmx_msg_blocks, который кандидат компилирует верно (статус §17).
...
**Заменено 2026-09-14 решениями 15–16 (LEAD_REVIEW_20260914.md §6).**
Перенос L1-модулей runtime прекращается. L2-runtime строится по SPEC
19.28.R2.2, 19.29.6 и 19.29.7 как данные Structure. Приёмка идёт по
собственным проверкам спецификации из 19.29.6 и сценариям модели §31–§36,
а не по L1-селфтестам. План:
[L2_RUNTIME_PLAN_20260914.md](L2_RUNTIME_PLAN_20260914.md). Пятнадцать уже
сделанных портов и их parity-раннеры остаются как свидетельство работы
транслятора и bootstrap, но не расширяются. Текст ниже сохранён как история.
