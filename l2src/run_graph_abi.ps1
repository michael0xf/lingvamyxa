            ...
            try {
                ...
                if ($text -match 'fn: l2_program_entry') {
                    ...
                    if ($case.stem -eq 'unit_msg_adapter') {
                        ...
                        if ($text -notmatch 'return: l2_p\d+_0\\root\\path_n') { throw 'the staged runtime field read was not emitted' }
                    ...
                    if ($case.stem -eq 'unit_msg_cursor') {
                        ...
                        if ($count.Value -notmatch 'return: l2_p0_0\\root\\path_n') { throw 'the count does not return the cached field' }
