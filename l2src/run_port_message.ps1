...
int main(int argc, char **argv) {
    ...
    if (lmx_msg_create(rt, 0U, init, 4U, &a, 0) != LMX_MSG_OK || a == 0) { fprintf(stderr, "warm-up: create\n"); return 91; }
    ...
    if (lmx_msg_create(rt, 0U, init, 4U, &a, 0) != LMX_MSG_OK) { fprintf(stderr, "warm-up: create again\n"); return 94; }
