...
int main(void) {
    return ! lm_trans_text_equals(& lm_test_hello, "hello") || lm_trans_text_same(& lm_test_hello, & lm_test_other) || ! lm_trans_text_starts_with(& lm_test_hello, "he") || lm_trans_text_all_char(& lm_test_hello, 'h') || lm_trans_text_is_operator_atom(& lm_test_hello) || lm_trans_put(stdout, "trans_test ok\n") != 0;
}
