...
static int lm_trans_emit_function(
    ...
    state->previous_cleanup_count = namespace_->cleanup_count;
    state->previous_loop_count = namespace_->loop_count;
    ...
    namespace_->cleanup_count = state->previous_cleanup_count;
    namespace_->loop_count = state->previous_loop_count;
    lm_trans_function_state_delete(state);
    lm_trans_namespace_leave_scope(namespace_);
    return status;
}
