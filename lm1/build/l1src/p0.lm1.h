/* generated by l1trans from l1src/p0.h.lm1 */
#ifndef LM_H_l1src_2Fp0_2Eh_2Elm1
#define LM_H_l1src_2Fp0_2Eh_2Elm1
...
typedef struct LmP0Text LmP0Text;
typedef struct LmP0Span LmP0Span;
typedef struct LmP0Diagnostic LmP0Diagnostic;
typedef struct LmP0Structure LmP0Structure;
typedef struct LmP0Trailer LmP0Trailer;
typedef struct LmP0Frame LmP0Frame;
typedef struct LmP0NodeAs LmP0NodeAs;
typedef struct LmP0Node LmP0Node;
typedef struct LmP0Field LmP0Field;
typedef struct LmP0StreamEvent LmP0StreamEvent;
typedef struct LmP0Document LmP0Document;
typedef struct LmP0PendingDelimiter LmP0PendingDelimiter;
typedef struct LmP0PendingMix LmP0PendingMix;
typedef struct LmP0IndentStack LmP0IndentStack;
typedef struct LmP0DisabledState LmP0DisabledState;
typedef struct LmP0Stack LmP0Stack;
typedef struct LmP0Dump LmP0Dump;
typedef struct LmP0DumpFrame LmP0DumpFrame;
typedef struct LmP0FieldParseLoopFrame LmP0FieldParseLoopFrame;
typedef struct LmP0PostprocessFrame LmP0PostprocessFrame;
...
struct LmP0PendingDelimiter {
    int active;
    LmP0StreamEvent * event;
};

struct LmP0PendingMix {
    LmP0StreamEvent * events;
    size_t count;
    size_t capacity;
};

struct LmP0IndentStack {
    size_t * columns;
    size_t count;
    size_t capacity;
};

struct LmP0DisabledState {
    int body_started;
    int pending_item;
    size_t base_level;
    size_t top_level;
...
struct LmP0FieldParseLoopFrame {
