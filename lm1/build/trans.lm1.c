...
static LmP0Text *lm_trans_l4_text_view_new(const char *text) {
    ...
    view = (LmP0Text *)lm_own_new_zero(sizeof(*view));
    if (view != 0) {
        *view = lm_trans_text_from_cstr(text != 0 ? text : "");
    }
    return view;
}
