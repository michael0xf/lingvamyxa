...
«в свободное плавание» нет: единственный выход из-под родителя — передача
вышестоящему, родителю родителя, и только handoff-safe ребёнка (19.29.7:
бегущий Message другому родителю не передаётся; граница handoff и передача
усыновлённого хранилища в рантайме — этот механизм). Для корневого Message
вышестоящий — виртуальный прародитель World Wide Mix (19.28.10) на уровне
...
описано алгоритмически, не реализовано. Найдено 2026-09-14 в
