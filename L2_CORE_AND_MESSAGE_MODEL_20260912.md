...
собственного узла callable Structure. Реализация размещения остаётся работой по интеграции,
...
не приняты. Задание Fable115036 выполняется в его frontend/copy области.
