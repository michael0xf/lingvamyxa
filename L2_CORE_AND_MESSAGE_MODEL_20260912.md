...
отправитель — ready получателю при admission; позднее чтение ничего не меняет.
...
возвращается сразу, ветвь в это время стекает, а не удерживается. Найдено 2026-09-14 в
