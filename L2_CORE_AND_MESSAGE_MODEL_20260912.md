...
привязке (поэтому право привязать или перепривязать Message — у полосы его
родителя либо у хоста вне turn, пока bootstrap остаётся хостом; Message не
отображает себя сам, и turn сиблинга его не отображает; уточнено 2026-09-14), семейная цепочка (первый и последний ребёнок, ссылки сиблингов,
...
сиротой: успешный сирота освобождает свою историю на своём end-turn;
...
запуск ОС корневым Message, делает его ребёнком этого корня. Тайм-аут
