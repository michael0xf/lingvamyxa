...
строгая: Message либо работает сам (свой turn, своё место под тем, кто его
запустил), либо за него работают (присоединён, усыновлён, закрыт); у них
разный генезис и потому разное место в иерархии. Передача надзора (правило 4)
переносит живой Message; усыновление переносит хранилище и завершает Message. Найдено 2026-09-14 в
