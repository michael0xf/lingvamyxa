...
ожидания. (5) Структуры уровня рантайма под локом исполнителя не принадлежат
ни одному Message: список корней, список слотов, очередь retire, собственная
очередь полосы. Что убирает это правило: списки готовых и списки контекстов
